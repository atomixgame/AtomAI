...
public class Evade implements Behaviour {
    ...
    public Evade(Vector3f location, Vector3f velocity, float speed, float targetSpeed, float tpf, Vector3f targetVelocity, Vector3f targetLocation) {
