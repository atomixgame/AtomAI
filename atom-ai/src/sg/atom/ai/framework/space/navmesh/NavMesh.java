...
import sg.atom.ai.framework.space.Cell.ClassifyResult;
import sg.atom.ai.framework.space.Cell.PathResult;
...
import sg.atom.ai.framework.space.NodeHeap;
import sg.atom.ai.framework.space.Node;
import sg.atom.ai.searching.pathfinding.core.Path;
import sg.atom.ai.framework.space.Plane;
import sg.atom.ai.framework.geom.Line2D;
import sg.atom.ai.framework.geom.Line2D.LineIntersect;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.ABisectsB;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.BBisectsA;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.CoLinear;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.LinesIntersect;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.Parallel;
import static sg.atom.ai.framework.geom.Line2D.LineIntersect.SegmentsIntersect;
...
public class NavMesh implements Savable {
    ...
    private volatile NodeHeap heap = new NodeHeap();
...
//                newWayPoint = snapPointToCell(currentCell, newWayPoint);
     ...
     * @return
     */
    public boolean isInLineOfSight(Cell StartCell, Vector3f StartPos, Vector3f EndPos) {
