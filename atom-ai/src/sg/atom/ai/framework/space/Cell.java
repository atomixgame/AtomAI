...
public class Cell implements Savable {
    ...
    public static class ClassifyResult {
        ...
        public PathResult result = PathResult.NoRelationship;
        public int side = 0;
        public Cell cell = null;
        public Vector2f intersection = new Vector2f();
     ...
     * @return
     */
    public boolean requestLink(Vector3f pointA, Vector3f pointB, Cell caller, float epsilon) {
    ...
    public Line2D getWall(int side) {
        return sides[side];
    }
...
//					&& end != Line2D.POINT_CLASSIFICATION.ON_LINE) {
     ...
     */
    public void projectPathOnCellWall(int sideNumber, Line2D motionPath) {
     ...
     * @return
     */
    public boolean forcePointToWallInterior(int sideNumber, Vector2f point) {
     ...
     * @return
     */
    public boolean forcePointToWallInterior(int sideNumber, Vector3f point) {
     ...
     * @return
     */
    public boolean forcePointToCellColumn(Vector2f point) {
     ...
     * @return
     */
    public boolean forcePointToCellColumn(Vector3f point) {
        Vector2f TestPoint2D = new Vector2f(point.x, point.z);
     ...
     * @return
     */
    public boolean processCell(NodeHeap heap) {
     ...
     * @return
     */
    public boolean queryForPath(NodeHeap heap, Cell caller, float arrivalCost) {
        if (sessionID != heap.getSessionID()) {
     ...
     * @param goal
     */
    public void computeHeuristic(Vector3f goal) {
...
//        wallDistances = capsule.readFloatArray("distances", new float[3]);
    ...
    public void checkAndLink(Cell other, float epsilon) {
